...
if(job==2) #ROC curve
{
	...
	plot(fp,sens,type="s",lwd=3,xlab="False positive rate",ylab="Sensitivity",
	     main="ROC curve for the LDA classification")
	text(.2,.4,paste("Empirical AUC (LDA) = ",round(100*AUC,1),"%",cex=""),
	     cex=1.5,adj=0,font=3)
